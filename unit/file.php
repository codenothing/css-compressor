...
// Include compressor and cli colorizer
...
Class FileTest
{
	 ...
	 * @param (string) original: Path to before test sheets
	 * @param (string) expected: Path to after test sheets
	...
	private function setup(){
		...
		$this->original = $this->root . 'sheets/before/' . $this->file;
		$this->expected = $this->root . 'sheets/after/' . $this->file;
	...
	/**
	 * Gets the contents of the test file (before&after), and stores the compression result
	 *
	 * @params none
	 */
